  ...
  try {
    ...
    const msg = {
      ...
      html:
        ...
        </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:10px 10px 10px 10px;" bgcolor="#111217" data-distribution="1">
        ...
        <tbody>
        <tr>
        <td style="padding:18px 40px 0px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="font-size: 24px; color: #111217">Olá, ${user.nome}. Você recebeu o link de redefinição de senha do Painel do Licenciado&nbsp;</span></div><div></div></div></td>
        </tr>
        </tbody>
        ...
        <tbody>
        <tr>
        <td style="padding:18px 40px 10px 0px; line-height:18px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="color: #111217"><strong>Clique no botão abaixo para acessar a tela de redefinição de senha. Caso você não tenha solicitado a redefinição, ignore este email.</strong></span></div><div></div></div></td>
        </tr>
        </tbody>
        ...
        <tbody>
        <tr>
        <td align="center" bgcolor="#daa520" class="inner-td" style="border-radius:6px; font-size:16px; text-align:left; background-color:inherit;">
        <a href="" style="background-color:#daa520; border:1px solid #fbca5b; border-color:#fbca5b; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 50px 12px 50px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;" target="_blank">Redefinir Senha</a>
        </td>
        </tr>
        </tbody>
        </table>
        ...
        <tbody>
        <tr>
        <td style="padding:18px 40px 10px 0px; line-height:18px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="color: #111217">Não responda a esta mensagem.</span></div>
        <div style="font-family: inherit; text-align: inherit"><br/></div>
        <div style="font-family: inherit; text-align: inherit"><span style="color: #111217">Caso precise entrar em contato conosco envie uma mensagem para o email abaixo:</span></div>
        <div style="font-family: inherit; text-align: inherit"><span style="color: #111217"><br/>
        </span></div>
        <div style="font-family: inherit; text-align: inherit"><span style="color: #111217">paineldolicenciado@valorfiscal.com</span></div><div></div></div></td>
        </tr>
        </tbody>
        </table></td>
        </tr>
