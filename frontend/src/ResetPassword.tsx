...
const ResetPassword = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!token) {
            setError('Token de redefinição não encontrado. Tente solicitar novamente.');
            return;
        }
        ...
        try {
            ...
            const errorMessage = err.response?.data?.error || 'Erro ao redefinir a senha.';
            ...
            <div className="p-1">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input
                        ...
                        required
                    />
                    <button className="botao-login" type="submit">Redefinir Senha</button>
                </form>
